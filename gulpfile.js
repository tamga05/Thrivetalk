...
// 3. После того, как всё корректно установится (в браузере Откроется приветственная Страничка "Hello, Andrey") и в папке с Новым проектом появятся
//    папки dist, node_modules, package-lock.json, нужно ОБЯЗАТЕЛЬНО удалить из этой папки с Новым проектом Пустые файлы index.html и style.css
//    (которые в самом начале перенесли из Папки my-gulp-start в эту папку с Новым проектом) и из папки src/assets/scss Удалить папку _style2.scss !!!
//    и в папке main.scss удалить код @import "./style2" !!!;
